    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                // Update status (COMPLETED triggers async event) — ADMIN only
                .requestMatchers(HttpMethod.PATCH, "/api/appointments/**").hasRole("ADMIN")
                // Update full record — USER or ADMIN
                .requestMatchers(HttpMethod.PUT, "/api/appointments/**").hasAnyRole("USER", "ADMIN")
                // Delete — ADMIN only
